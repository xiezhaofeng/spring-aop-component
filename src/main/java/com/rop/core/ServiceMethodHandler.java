...
import com.rop.enums.CollectType;
...
public class ServiceMethodHandler {
    ...
    public static String methodWithVersion(String module, String methodName, String version) {
        String key = new StringBuffer(module).append(RopConstant.SHIFT_THREE).append(methodName).append(RopConstant.SHIFT_THREE).append(version).toString().intern();
        return key;
    }
